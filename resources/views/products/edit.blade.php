...
<div class="container col-9 col-md-7 col-lg-7 center mt-4">
    <form class="form-horizontal" action="{{ route('products.update',$product->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" placeholder="Enter slug" name="slug" value="{{$product->slug}}" required>
            @error("slug")
        ...
        <div class="form-group">
            ...
            <div class="custom-file">
                <input type="file" class="custom-file-input" id="customFile" name="image1" value="{{$product->image1}}" required>
                <label class="custom-file-label" for="customFile">{{$product->image1}}</label>
                @error("image1")
        ...
        <div class="form-group">
            ...
            <div class="custom-file">
                <input type="file" class="custom-file-input" id="customFile" name="image2" value="{{$product->image2}}" required>
                <label class="custom-file-label" for="customFile">{{$product->image2}}</label>
                @error("image2")
